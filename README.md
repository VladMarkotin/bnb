...
Суть:
Проект - это справочник сотрудников компании.Есть функция добавления сотрудника. При добавлении сотрудника необходимо указать 3 поля: ФИО, Email, Телефоны (у сотрудника их может быть несколько) и ID офиса, где сотрудник работает. Также в базу автоматически заносится время принятия сотрудника на работу.
